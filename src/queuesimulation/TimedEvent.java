...
public abstract class TimedEvent{
    ...
    private final Time event_time;
    
    public TimedEvent(Time event_time){
        this.event_time = new Time(event_time);
    }
    public Time getEventTime(){
        return event_time;
    }
    public void setEventTime(Time time){
        event_time.setTime(time);
    }
    public abstract void run(QueueSystem qs);
